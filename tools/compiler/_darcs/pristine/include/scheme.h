...
#define SCHEME_TYPE_ID(type) Scheme_ ## type ## _Type
...
#define SCHEME_STRING_GET_STR(obj)		\
	(((Scheme_String_t *)obj)->str)

SCHEME_TYPEDEF(Symbol, char *str; int str_len;)
#define SCHEME_SYMBOL_GET_STR(obj)		\
	(((Scheme_Symbol_t *)obj)->str)
